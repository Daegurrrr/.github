...
## 레포지토리
기타 상세는 [프론트엔드 README.md](https://github.com/Daegurrrr/CaptureMate_FE/blob/develop/README.md), [백엔드 README.md](https://github.com/Daegurrrr/CaptureMate_BE/blob/develop/README.md), [AI README.md](https://github.com/Daegurrrr/CaptureMate_AI/blob/develop/README.md))를 참고하세요.
